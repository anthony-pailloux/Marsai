...
/** Puce / pill de section (style conference) */
export const HOME_PILL =
  "inline-flex shrink-0 items-center gap-2.5 rounded-full border border-black/10 bg-black/5 px-5 py-2 dark:border-white/10 dark:bg-white/5";

/** Pill eyebrow / label de section */
export const HOME_EYEBROW = `${HOME_PILL} self-start`;

/** Pill cliquable (CTA secondaire) */
export const HOME_PILL_LINK =
  `${HOME_PILL} transition-colors hover:bg-black/10 dark:hover:bg-white/10`;
...
export const HOME_CARD_ICON =
  "flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-black/[0.04] text-brand dark:bg-white/10";

export const HOME_CARD_ICON_IMG = "h-7 w-7 object-contain home-brand-icon";
